...
{
    public class when_successfully_adding_a_sample
    {
        ...
        It should_dispatch_the_command =
            () => Mock.Get(_commandDispatcher)
                .Verify(
                    x => x.Dispatch(_userSession, WithExpected.Object(new AddSample(_request.Name), AllowAnonymous.No)));
    }
}